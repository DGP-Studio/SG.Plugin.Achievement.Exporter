...
namespace Achievement.Exporter.Plugin
{
    ...
    public class ImageRecognition
    {
        ...
        public static Rectangle CalculateSampleArea(Bitmap imgSrc)
        {
            ...
            if (lines.Count >= 2)
            {
                Rectangle rect = new(lines[0].X, lines[0].Y,
                    lines[0].Width, lines.Last().Y - lines[0].Y);
        ...
        {
            Bitmap bitmap = new(imgSrc.Width, imgSrc.Height);
            BitmapData data = imgSrc.LockBits(new Rectangle(0, 0, imgSrc.Width, imgSrc.Height), ImageLockMode.ReadWrite, PixelFormat.Format24bppRgb);
        ...
        {
            Bitmap img = new(w, h, PixelFormat.Format24bppRgb);
